...
function UploadDropzone(props) {
    ...
    const { startUpload, isUploading, routeConfig } = buttonClient.__useUploadThingInternal(shared.resolveMaybeUrlArg($props.url), $props.endpoint, $props.fetch ?? globalThis.fetch, {
    ...
    const { getRootProps, getInputProps, isDragActive, rootRef } = useDropzone({
        onDrop,
        multiple,
        accept: shared.generateClientDropzoneAccept(fileTypes),
        disabled
    });
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx("button", {
                className: cn("group relative mt-4 flex h-10 w-36 items-center justify-center overflow-hidden rounded-md border-none text-base text-white", "after:absolute after:left-0 after:h-full after:w-[var(--progress-width)] after:bg-blue-600 after:transition-[width] after:duration-500 after:content-['']", "focus-within:ring-2 focus-within:ring-blue-600 focus-within:ring-offset-2", "disabled:pointer-events-none", "data-[state=disabled]:cursor-not-allowed data-[state=readying]:cursor-not-allowed", "data-[state=disabled]:bg-blue-400 data-[state=ready]:bg-blue-600 data-[state=readying]:bg-blue-400 data-[state=uploading]:bg-blue-400", shared.styleFieldToClassName($props.appearance?.button, styleFieldArg)),
                style: {
                    "--progress-width": `${uploadProgress}%`,
                    ...shared.styleFieldToCssObject($props.appearance?.button, styleFieldArg)
                },
 ...
 */ function useDropzone({ accept, disabled = false, maxSize = Number.POSITIVE_INFINITY, minSize = 0, multiple = true, maxFiles = 0, onDrop }) {
    ...
    const onClick = React.useCallback(()=>{
        ...
        if (shared.isIeOrEdge()) setTimeout(openFileDialog, 0);
        else openFileDialog();
    }, [
        openFileDialog
    ]);
